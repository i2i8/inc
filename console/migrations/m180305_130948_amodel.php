...
/**
 * Class m180305_130948_amodel
 */
class m180305_130948_amodel extends Migration
{
    const TBL_AMODEL= '{{%amodel}}';
    public function safeUp()
    {
        ...
        $this->createTable(self::TBL_AMODEL, [
            'id'	    => $this->primaryKey(),
            //父序列号，必须为Null，因为第一次save的时候，自增id还没生成，amid是第二次save前，由前一次save主入库后获取到的
            'amid'      => $this->integer()->Null()->COMMENT('关联索引'),
            //品牌型号
        ...
        $this->createIndex('amidIndex', self::TBL_AMODEL, 'amid', false);
    }
    
    public function safeDown()
    {
        $this->dropTable(self::TBL_AMODEL);
    }
}
